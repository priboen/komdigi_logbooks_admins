...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/bg-home.png
  AssetGenImage get bgHome => const AssetGenImage('assets/images/bg-home.png');
...
class $AssetsIconsMenuGen {
  ...
  /// File path: assets/icons/menu/jumlah_pesanan.svg
  SvgGenImage get jumlahPesanan =>
      const SvgGenImage('assets/icons/menu/jumlah_pesanan.svg');

  /// File path: assets/icons/menu/transaksi_hari_ini.svg
  SvgGenImage get transaksiHariIni =>
      const SvgGenImage('assets/icons/menu/transaksi_hari_ini.svg');

  /// List of all assets
  List<SvgGenImage> get values => [jumlahPesanan, transaksiHariIni];
}
...
class $AssetsIconsNavGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [history, home, order, profile];
}
